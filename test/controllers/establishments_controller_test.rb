...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post establishments_url, params: { establishment: { link_name: @establishment.link_name, name: @establishment.name, user_id: @establishment.user_id } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { link_name: @establishment.link_name, name: @establishment.name, user_id: @establishment.user_id } }
